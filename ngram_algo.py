...
class NGram:
    ...
    def ngram(self):
        if isinstance(self.N, int):
            if self.N < len(self.tokenizedSentence):
                tuplesList = []
                ...
                print('You choose a greater number than the length of the list. Please choose a smaller number.')
        else:
            print('The attribute N is not a number. Please enter a number.')
